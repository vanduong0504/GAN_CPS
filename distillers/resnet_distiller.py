...
class ResnetDistiller(BaseResnetDistiller):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        parser.add_argument('--pretrained_netG', type=str, required=True,
                            help='specify pretrained generator architecture',
                            choices=['resnet_9blocks', 'mobile_resnet_9blocks','super_mobile_resnet_9blocks', 'sub_mobile_resnet_9blocks'
