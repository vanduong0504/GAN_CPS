...
def main(opt):
    ...
    if opt.model == 'mobile_resnet':
        ...
        super_model = MobileResnetGenerator(input_nc, output_nc, ngf=opt.ngf,
                                            norm_layer=nn.InstanceNorm2d, n_blocks=opt.nblocks)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nblocks', type=int, default=9,
                        choices=[6, 9], help='specify the number of blocks you want to export')
