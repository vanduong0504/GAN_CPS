...
def define_G(netG, **kwargs):
    ...
    if netG in ['resnet_9blocks', 'mobile_resnet_9blocks', 'super_mobile_resnet_9blocks' , 'resnet_6blocks', 'mobile_resnet_6blocks', 'super_mobile_resnet_6blocks']:
        ...
        net = Generator(input_nc, output_nc, ngf=ngf, norm_layer=norm_layer,
                        dropout_rate=dropout_rate, n_blocks=block)
    elif netG in ['sub_mobile_resnet_9blocks', 'sub_mobile_resnet_6blocks']:
...
def get_netG_cls(netG):
    ...
    elif netG in ['mobile_resnet_9blocks', 'mobile_resnet_6blocks']:
        from models.modules.resnet_architecture.mobile_resnet_generator import MobileResnetGenerator
        return MobileResnetGenerator
    elif netG in ['super_mobile_resnet_9blocks', 'super_mobile_resnet_6blocks']:
